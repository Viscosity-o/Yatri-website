...
import { TouristClusterMap } from '../components/maps/TouristClusterMap';
import { 
  Users, 
  MapPin, 
  TrendingUp, 
...
const sidebarSections = [
  ...
  { 
    ...
    icon: Users, 
    description: 'Cluster analysis & management'
  },
  { 
    id: 'digital-ids', 
    label: 'Digital IDs', 
    ...
    switch (activeSection) {
      case 'overview':
        return (
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-semibold text-slate-900">Tourism Safety Overview</h1>
              <p className="text-slate-600 mt-1">Monitor tourist locations and emergency alerts in real-time</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Interactive map showing tourist clusters and locations</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Real-time monitoring of tourist emergencies</CardDescription>
                </CardHeader>
                      ...
                      <CardContent className="p-4">
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <Badge className={`${getAlertPriorityColor(alert.priority)} text-xs px-2 py-1`}>
                              {alert.priority}
                            </Badge>
                          </div>
                          ...
                          <div className="text-sm text-slate-700">
                            ...
                            <p className="text-slate-500">{alert.location.address}</p>
                            <p className="text-slate-500">{alert.timeAgo} • {alert.assignedUnit}</p>
                          </div>
      ...
      case 'clusters':
        return (
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-semibold text-slate-900">Tourist Cluster Analysis</h1>
              <p className="text-slate-600 mt-1">Monitor tourist concentrations and movement patterns</p>
            </div>

            <Card>
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle>Tourist Cluster Analysis</CardTitle>
                ...
                <CardDescription>Real-time monitoring of tourist concentrations and movement patterns</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Tourist Count</TableHead>
                  ...
                  <TableBody>
                    {mockClusters.map((cluster, index) => (
                      <TableRow key={index}>
                        <TableCell className="font-medium">{cluster.location}</TableCell>
                        <TableCell>{cluster.tourists}</TableCell>
                        <TableCell>
                          <Badge 
                            variant={
                        ...
                        <TableCell>
                          <span className={cluster.trend.startsWith('+') ? 'text-green-600' : 'text-red-600'}>
                            {cluster.trend}
                          </span>
                        </TableCell>
                        <TableCell>
                          <Progress value={(cluster.tourists / 300) * 100} className="w-20" />
                        </TableCell>
                        <TableCell>
                          <div className="flex space-x-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Tourist Density Heat Map</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-gradient-to-br from-blue-100 via-green-100 to-yellow-100 rounded-lg p-8 h-64 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <TrendingUp className="w-16 h-16 text-gray-400 mx-auto mb-4" />
                      <p className="text-lg font-medium text-gray-600">Live Heat Map</p>
                      <p className="text-sm text-gray-500">Tourist density across major attractions</p>
                    </div>
                  </div>
                  
                  {/* Mock density indicators */}
                  <div className="absolute top-16 left-1/4 w-12 h-12 bg-green-500/40 rounded-full"></div>
                  <div className="absolute top-32 right-1/3 w-16 h-16 bg-yellow-500/40 rounded-full"></div>
                  <div className="absolute bottom-24 left-1/2 w-8 h-8 bg-red-500/40 rounded-full"></div>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Blockchain-secured digital identities for registered tourists</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    {mockDigitalIds.map((id) => (
                      <TableRow key={id.id}>
                        <TableCell className="font-mono text-sm">{id.id}</TableCell>
                        <TableCell className="font-medium">{id.name}</TableCell>
                        <TableCell>{id.country}</TableCell>
                        <TableCell>
                          <Badge variant={id.verificationStatus === 'Verified' ? 'default' : 'secondary'}>
                            {id.verificationStatus}
                          </Badge>
                        </TableCell>
                        <TableCell>{id.registrationDate}</TableCell>
                        <TableCell>{id.lastActivity}</TableCell>
                        <TableCell>
                          <div className="flex space-x-2">
                            <Button size="sm" variant="outline">View</Button>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 rounded-lg border">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge className={`${getAlertPriorityColor(selectedAlertDetails.priority)}`}>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-900">{selectedAlertDetails.tourist.age} years</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    <Label className="text-sm font-medium text-slate-600">Incident Type</Label>
                    <p className="text-slate-900">{selectedAlertDetails.type}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label className="text-sm font-medium text-slate-600">Location Zone</Label>
                    <p className="text-slate-900">{selectedAlertDetails.location.zone}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-slate-600">Response Details</Label>
                    <p className="text-slate-900">
                      Unit <span className="font-semibold">{selectedAlertDetails.assignedUnit}</span> assigned (ETA: {selectedAlertDetails.eta})
                    </p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-slate-600">Alert Confidence</Label>
                    <p className="text-slate-900">{selectedAlertDetails.confidence}% accuracy</p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <Badge className={`${getAlertStatusColor(selectedAlertDetails.status)} px-3 py-1`}>
                    {selectedAlertDetails.status.toUpperCase()}
                  </Badge>
                  <p className="text-sm text-blue-700 mt-2">
                    Tourism Department is monitoring this incident and coordinating with police response teams.
                  </p>
                </div>
